...
use vulkano::{
    ...
    pipeline::{
        graphics::{
            ...
            vertex_input::{BuffersDefinition, VertexMemberInfo},
...
impl AppOld {
    ...
    pub fn run() -> ! {
        ...
        let surface = WindowBuilder::new()
            .with_title(format!("{} Uffice", uffice_lib::constants::vendor::NAME))
            ...
            .filter_map(|p| {
                ...
                p.queue_family_properties()
                    ...
                    .position(|(i, q)| {
                        ...
                        q.queue_flags.intersects(&QueueFlags{ graphics: true, ..Default::default() })
        ...
        unsafe impl vulkano::pipeline::graphics::vertex_input::Vertex for Vertex {
            fn member(name: &str) -> Option<vulkano::pipeline::graphics::vertex_input::VertexMemberInfo> {
                match name {
                    "position" => Some(VertexMemberInfo{
                        ty: vulkano::pipeline::graphics::vertex_input::VertexMemberTy::F32,
                        array_size: 2,
                        offset: 0,
                    }),
                    _ => None
